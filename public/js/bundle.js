...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWR1YXJkbWF0ZWkiLCJhIjoiY2p1ZHpvbmd0MG1uNTN5dGNvanllcGdjZyJ9.HASRh6RitbeSWLT0M66Ekw';
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_gMQyzTnU4P7giIRAYUS5QZ5o008OVOGnQz');
            _context.prev = 1;
            _context.next = 4;
